 ...
 * @generated
 */
public class Coreflight00Switch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Coreflight00Package.APPLICATIONS: {
				...
				T result = caseApplications(applications);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Coreflight00Package.INTER_TASK_MESSAGE_ROUTER: {
				InterTaskMessageRouter interTaskMessageRouter = (InterTaskMessageRouter)theEObject;
				T result = caseInterTaskMessageRouter(interTaskMessageRouter);
				if (result == null) result = caseIdentifiable(interTaskMessageRouter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Coreflight00Package.MESSAGE_PORT: {
				...
				if (result == null) result = caseIdentifiable(messagePort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Coreflight00Package.PUBLISHER: {
				...
				if (result == null) result = caseMessagePort(publisher);
			...
			case Coreflight00Package.SUBSCRIBER: {
				...
				if (result == null) result = caseMessagePort(subscriber);
				if (result == null) result = caseIdentifiable(subscriber);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Coreflight00Package.SYSTEM: {
				coreflight00.System system = (coreflight00.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseApplications(Applications object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inter Task Message Router</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inter Task Message Router</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterTaskMessageRouter(InterTaskMessageRouter object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSystem(coreflight00.System object) {
		return null;
	}
