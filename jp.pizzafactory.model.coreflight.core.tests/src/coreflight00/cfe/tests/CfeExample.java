...
import coreflight00.cfe.util.CfeResourceFactoryImpl;
import java.io.File;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>cfe</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CfeExample {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new CfeResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(CfePackage.eNS_URI, 
			 CfePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.cfe")); //$NON-NLS-1$
				DocumentRoot documentRoot = CfeFactory.eINSTANCE.createDocumentRoot();
				EventServices root = CfeFactory.eINSTANCE.createEventServices();
				documentRoot.setEVENTSERVICES(root);
