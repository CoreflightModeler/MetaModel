/**
 */
package coreflight00.cfe.provider;
...
/**
 * This is the item provider adapter for a {@link coreflight00.cfe.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CfePackage.Literals.DOCUMENT_ROOT__EVENTSERVICES);
			childrenFeatures.add(CfePackage.Literals.DOCUMENT_ROOT__EXECUTIVESERVICES);
			childrenFeatures.add(CfePackage.Literals.DOCUMENT_ROOT__SOFTWAREBUS);
			childrenFeatures.add(CfePackage.Literals.DOCUMENT_ROOT__TABLESERVICES);
			childrenFeatures.add(CfePackage.Literals.DOCUMENT_ROOT__TIMESERVICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CfePackage.Literals.DOCUMENT_ROOT__EVENTSERVICES,
				 CfeFactory.eINSTANCE.createEventServices()));

		newChildDescriptors.add
			(createChildParameter
				(CfePackage.Literals.DOCUMENT_ROOT__EXECUTIVESERVICES,
				 CfeFactory.eINSTANCE.createExecutiveServices()));

		newChildDescriptors.add
			(createChildParameter
				(CfePackage.Literals.DOCUMENT_ROOT__SOFTWAREBUS,
				 CfeFactory.eINSTANCE.createSoftwareBus()));

		newChildDescriptors.add
			(createChildParameter
				(CfePackage.Literals.DOCUMENT_ROOT__TABLESERVICES,
				 CfeFactory.eINSTANCE.createTableServices()));

		newChildDescriptors.add
			(createChildParameter
				(CfePackage.Literals.DOCUMENT_ROOT__TIMESERVICES,
